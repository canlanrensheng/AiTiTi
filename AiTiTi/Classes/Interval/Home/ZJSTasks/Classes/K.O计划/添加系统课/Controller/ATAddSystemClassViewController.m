//
//  ATAddSystemClassViewController.m
//  AiTiTi
//
...
@interface ATAddSystemClassViewController ()
...
@implementation ATAddSystemClassViewController
...
- (void)tx_configSubViews{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ATAddSystemClassCell" bundle:nil] forCellReuseIdentifier:@"ATAddSystemClassCell"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ATAddSystemClassCell * cell = [tableView dequeueReusableCellWithIdentifier:@"ATAddSystemClassCell"];
...
- (UIButton *)selectButton{
    if(!_selectButton){
        _selectButton = [UIButton creatButton:^(UIButton *button) {
            ...
            button.backgroundColor = RGB(255, 138, 4);
            //@weakify(self);
