//
//  ATBaseSecletClassViewController.m
//  AiTiTi
//
...
#import "ATBaseSecletClassViewController.h"

#import "ATSelectClassCell.h"

@interface ATBaseSecletClassViewController ()


@end

@implementation ATBaseSecletClassViewController
...
- (void)tx_configSubViews{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ATSelectClassCell" bundle:nil] forCellReuseIdentifier:@"ATSelectClassCell"];
    
    [self.tableView mas_updateConstraints:^(MASConstraintMaker *make) {
        make.edges.equalTo(self.view).insets(UIEdgeInsetsMake(0, 0, kBottomBarHeight + 10, 0));
    }];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ATSelectClassCell * cell = [tableView dequeueReusableCellWithIdentifier:@"ATSelectClassCell"];
