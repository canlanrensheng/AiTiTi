...
- (NSMutableArray *)controllers{
    if (!_controllers) {
        ...
        for(int i = 0; i < self.controllersClass.count;i++){
            ATBaseSecletClassViewController *listVC = [[ATBaseSecletClassViewController alloc] init];
            [self addChildViewController:listVC];
            [controllers addObject:listVC];
            
//            ATBaseSecletClassViewController *mapVC = [[ATBaseSecletClassViewController alloc] init];
